...
Thank you for considering contributing to the Kibo project! We welcome contributions from the community. Before you begin, please review the guidelines below to ensure a smooth contribution process.
...
To contribute to Kibo, you need to clone the project repository to your local machine. Here's how you can do it:
...
3. Run the following command to clone the repository:
   ```
   git clone https://github.com/Rohit-554/kibo.git
   ```
## Building and Running the App

1. Launch Android Studio.
2. Click on "Open an existing Android Studio project."
3. Navigate to the directory where you cloned the Kibo repository and select the project folder.
...
7. Android Studio will build the app and install it on the selected device or emulator. You should now see the Kibo app running.
...
Thank you for contributing to Kibo! We appreciate your help in making this Kibo app better for the community.
